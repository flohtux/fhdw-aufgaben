...
public class MateriallistValueICProxi extends PersistentInCacheProxiOptimistic implements PersistentMateriallistValue{
    
    public MateriallistValueICProxi(long objectId) {
        super(objectId);
    }
    public MateriallistValueICProxi(PersistentObject object) {
        super(object);
    }
