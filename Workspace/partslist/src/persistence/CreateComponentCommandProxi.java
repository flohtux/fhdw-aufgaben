...
public class CreateComponentCommandProxi extends PersistentProxi implements PersistentCreateComponentCommand{
    
    public CreateComponentCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateComponentCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
