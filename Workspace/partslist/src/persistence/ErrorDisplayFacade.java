...
public class ErrorDisplayFacade{
    ...
    public ErrorDisplayProxi newErrorDisplay(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (ErrorDisplayProxi)PersistentProxi.createProxi(createMinusStorePlus, -108);
        ...
        return (ErrorDisplayProxi)PersistentProxi.createProxi(id, -108);
    }
