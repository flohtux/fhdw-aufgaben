...
public class CachedICProxi extends StateICProxi implements PersistentCached{
    
    public CachedICProxi(long objectId) {
        super(objectId);
    }
    public CachedICProxi(PersistentObject object) {
        super(object);
    }
