...
public class AddComponentCommandProxi extends PersistentProxi implements PersistentAddComponentCommand{
    
    public AddComponentCommandProxi(long objectId) {
        super(objectId);
    }
    public AddComponentCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
