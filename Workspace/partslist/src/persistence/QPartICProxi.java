...
public class QPartICProxi extends PersistentInCacheProxiOptimistic implements PersistentQPart{
    
    public QPartICProxi(long objectId) {
        super(objectId);
    }
    public QPartICProxi(PersistentObject object) {
        super(object);
    }
