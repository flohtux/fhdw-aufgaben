...
public class NotCachedProxi extends StateProxi implements PersistentNotCached{
    
    public NotCachedProxi(long objectId) {
        super(objectId);
    }
    public NotCachedProxi(PersistentInCacheProxi object) {
        super(object);
    }
