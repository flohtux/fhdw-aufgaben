...
public class MateriallistProxi extends PersistentProxi implements PersistentMateriallist{
    
    public MateriallistProxi(long objectId) {
        super(objectId);
    }
    public MateriallistProxi(PersistentInCacheProxi object) {
        super(object);
    }
