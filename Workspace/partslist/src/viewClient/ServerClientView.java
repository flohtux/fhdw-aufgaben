...
public class ServerClientView extends JPanel implements ExceptionAndEventHandler{
	...
	**/
    ...
    private java.util.Vector<javax.swing.JButton> getToolButtonsForStaticOperations() {
        ...
        currentButton = new javax.swing.JButton("Fehler l√∂sen");
        currentButton.addActionListener(new java.awt.event.ActionListener(){
            public void actionPerformed(java.awt.event.ActionEvent e) {
                if (javax.swing.JOptionPane.showConfirmDialog(getNavigationPanel(), "Fehler l√∂sen" + Wizard.ConfirmQuestionMark, "Best‰tigen", javax.swing.JOptionPane.OK_CANCEL_OPTION, javax.swing.JOptionPane.QUESTION_MESSAGE, null) == javax.swing.JOptionPane.YES_OPTION){
                    try {
