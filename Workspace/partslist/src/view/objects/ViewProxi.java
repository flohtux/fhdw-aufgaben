  ...
  private static ProxiFactory [] getTheProxiFactories(){
	if (proxiFactories == null){
        ...
        proxiFactories[4] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new QPartProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[6] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new CachedProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[10] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new MateriallistProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[12] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new NotCachedProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[15] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new MateriallistValueProxi(objectId, classId, connectionKey);
            }
        };
	}
