...
public class ChangeCurrencyCommandICProxi extends PersistentInCacheProxi implements PersistentChangeCurrencyCommand{
    
    public ChangeCurrencyCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeCurrencyCommandICProxi(PersistentObject object) {
        super(object);
    }
