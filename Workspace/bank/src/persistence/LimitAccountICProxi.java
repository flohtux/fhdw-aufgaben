...
public class LimitAccountICProxi extends PersistentInCacheProxiOptimistic implements PersistentLimitAccount{
    
    public LimitAccountICProxi(long objectId) {
        super(objectId);
    }
    public LimitAccountICProxi(PersistentObject object) {
        super(object);
    }
