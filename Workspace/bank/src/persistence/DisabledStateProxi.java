...
public class DisabledStateProxi extends TriggerStateProxi implements PersistentDisabledState{
    
    public DisabledStateProxi(long objectId) {
        super(objectId);
    }
    public DisabledStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
