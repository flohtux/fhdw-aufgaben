...
public class EventWrapperProxi extends PersistentProxi implements PersistentEventWrapper{
    
    public EventWrapperProxi(long objectId) {
        super(objectId);
    }
    public EventWrapperProxi(PersistentInCacheProxi object) {
        super(object);
    }
