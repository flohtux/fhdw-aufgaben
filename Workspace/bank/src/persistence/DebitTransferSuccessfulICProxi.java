...
public class DebitTransferSuccessfulICProxi extends PersistentInCacheProxiOptimistic implements PersistentDebitTransferSuccessful{
    
    public DebitTransferSuccessfulICProxi(long objectId) {
        super(objectId);
    }
    public DebitTransferSuccessfulICProxi(PersistentObject object) {
        super(object);
    }
