...
public class NoDebitTransferProxi extends PersistentProxi implements PersistentNoDebitTransfer{
    
    public NoDebitTransferProxi(long objectId) {
        super(objectId);
    }
    public NoDebitTransferProxi(PersistentInCacheProxi object) {
        super(object);
    }
