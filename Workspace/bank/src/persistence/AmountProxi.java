...
public class AmountProxi extends PersistentProxi implements PersistentAmount{
    
    public AmountProxi(long objectId) {
        super(objectId);
    }
    public AmountProxi(PersistentInCacheProxi object) {
        super(object);
    }
