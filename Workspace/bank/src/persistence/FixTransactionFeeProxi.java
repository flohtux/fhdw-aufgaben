...
public class FixTransactionFeeProxi extends TransactionFeeProxi implements PersistentFixTransactionFee{
    
    public FixTransactionFeeProxi(long objectId) {
        super(objectId);
    }
    public FixTransactionFeeProxi(PersistentInCacheProxi object) {
        super(object);
    }
