...
public class DebitGrantListeICProxi extends PersistentInCacheProxiOptimistic implements PersistentDebitGrantListe{
    
    public DebitGrantListeICProxi(long objectId) {
        super(objectId);
    }
    public DebitGrantListeICProxi(PersistentObject object) {
        super(object);
    }
