...
public class EnabledStateICProxi extends TriggerStateICProxi implements PersistentEnabledState{
    
    public EnabledStateICProxi(long objectId) {
        super(objectId);
    }
    public EnabledStateICProxi(PersistentObject object) {
        super(object);
    }
