...
public class AllCompensationListeICProxi extends PersistentInCacheProxiOptimistic implements PersistentAllCompensationListe{
    
    public AllCompensationListeICProxi(long objectId) {
        super(objectId);
    }
    public AllCompensationListeICProxi(PersistentObject object) {
        super(object);
    }
