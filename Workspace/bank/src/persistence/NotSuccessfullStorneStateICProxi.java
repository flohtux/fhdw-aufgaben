...
public class NotSuccessfullStorneStateICProxi extends StornoStateICProxi implements PersistentNotSuccessfullStorneState{
    
    public NotSuccessfullStorneStateICProxi(long objectId) {
        super(objectId);
    }
    public NotSuccessfullStorneStateICProxi(PersistentObject object) {
        super(object);
    }
