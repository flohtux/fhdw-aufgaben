...
public class ConnectionHandler {
    ...
    public SuccessfullStateFacade theSuccessfullStateFacade;
    ...
    public SuccessfullStornoStateFacade theSuccessfullStornoStateFacade;
    ...
    public NotSuccessfullStorneStateFacade theNotSuccessfullStorneStateFacade;
    ...
    public DebitNoteTransferFacade theDebitNoteTransferFacade;
    public NotSuccessfullStateFacade theNotSuccessfullStateFacade;
    ...
    public DebitNoteTransferTransactionFacade theDebitNoteTransferTransactionFacade;
    public MoneyFacade theMoneyFacade;
    public BankFacade theBankFacade;
    public DebitNoteTransferStateFacade theDebitNoteTransferStateFacade;
	...
	public void connect(String databaseName, String currentSchemaName, String user, char[] pw, boolean autoCommit) throws PersistenceException {
		try {
            ...
            this.theSuccessfullStateFacade= new SuccessfullStateFacade(this.schemaName, this.con);
            ...
            this.theSuccessfullStornoStateFacade= new SuccessfullStornoStateFacade(this.schemaName, this.con);
            ...
            this.theNotSuccessfullStorneStateFacade= new NotSuccessfullStorneStateFacade(this.schemaName, this.con);
            ...
            this.theDebitNoteTransferFacade= new DebitNoteTransferFacade(this.schemaName, this.con);
            this.theNotSuccessfullStateFacade= new NotSuccessfullStateFacade(this.schemaName, this.con);
            ...
            this.theDebitNoteTransferTransactionFacade= new DebitNoteTransferTransactionFacade(this.schemaName, this.con);
            this.theMoneyFacade= new MoneyFacade(this.schemaName, this.con);
            this.theBankFacade= new BankFacade(this.schemaName, this.con);
            this.theDebitNoteTransferStateFacade= new DebitNoteTransferStateFacade(this.schemaName, this.con);
