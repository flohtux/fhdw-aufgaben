...
public class BankOwnAccountPxProxi extends PersistentProxi implements PersistentBankOwnAccountPx{
    
    public BankOwnAccountPxProxi(long objectId) {
        super(objectId);
    }
    public BankOwnAccountPxProxi(PersistentInCacheProxi object) {
        super(object);
    }
