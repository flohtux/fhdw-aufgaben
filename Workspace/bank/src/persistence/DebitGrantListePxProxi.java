...
public class DebitGrantListePxProxi extends PersistentProxi implements PersistentDebitGrantListePx{
    
    public DebitGrantListePxProxi(long objectId) {
        super(objectId);
    }
    public DebitGrantListePxProxi(PersistentInCacheProxi object) {
        super(object);
    }
