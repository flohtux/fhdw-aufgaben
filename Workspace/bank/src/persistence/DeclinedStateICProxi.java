...
public class DeclinedStateICProxi extends CompensationRequestStateICProxi implements PersistentDeclinedState{
    
    public DeclinedStateICProxi(long objectId) {
        super(objectId);
    }
    public DeclinedStateICProxi(PersistentObject object) {
        super(object);
    }
