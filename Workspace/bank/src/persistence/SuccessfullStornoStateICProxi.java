...
public class SuccessfullStornoStateICProxi extends StornoStateICProxi implements PersistentSuccessfullStornoState{
    
    public SuccessfullStornoStateICProxi(long objectId) {
        super(objectId);
    }
    public SuccessfullStornoStateICProxi(PersistentObject object) {
        super(object);
    }
