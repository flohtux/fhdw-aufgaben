...
public class CompensatedStateICProxi extends DebitTransferStateICProxi implements PersistentCompensatedState{
    
    public CompensatedStateICProxi(long objectId) {
        super(objectId);
    }
    public CompensatedStateICProxi(PersistentObject object) {
        super(object);
    }
