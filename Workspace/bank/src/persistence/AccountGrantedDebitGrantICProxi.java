...
public class AccountGrantedDebitGrantICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountGrantedDebitGrant{
    
    public AccountGrantedDebitGrantICProxi(long objectId) {
        super(objectId);
    }
    public AccountGrantedDebitGrantICProxi(PersistentObject object) {
        super(object);
    }
