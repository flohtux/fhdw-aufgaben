...
public class AccountMoney2ICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountMoney2{
    
    public AccountMoney2ICProxi(long objectId) {
        super(objectId);
    }
    public AccountMoney2ICProxi(PersistentObject object) {
        super(object);
    }
