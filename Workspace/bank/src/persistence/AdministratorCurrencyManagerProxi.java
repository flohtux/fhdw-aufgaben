...
public class AdministratorCurrencyManagerProxi extends PersistentProxi implements PersistentAdministratorCurrencyManager{
    
    public AdministratorCurrencyManagerProxi(long objectId) {
        super(objectId);
    }
    public AdministratorCurrencyManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
