...
public class CompensationPendingRequestsProxi extends PersistentProxi implements PersistentCompensationPendingRequests{
    
    public CompensationPendingRequestsProxi(long objectId) {
        super(objectId);
    }
    public CompensationPendingRequestsProxi(PersistentInCacheProxi object) {
        super(object);
    }
