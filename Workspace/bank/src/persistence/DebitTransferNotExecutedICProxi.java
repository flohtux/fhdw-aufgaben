...
public class DebitTransferNotExecutedICProxi extends PersistentInCacheProxiOptimistic implements PersistentDebitTransferNotExecuted{
    
    public DebitTransferNotExecutedICProxi(long objectId) {
        super(objectId);
    }
    public DebitTransferNotExecutedICProxi(PersistentObject object) {
        super(object);
    }
