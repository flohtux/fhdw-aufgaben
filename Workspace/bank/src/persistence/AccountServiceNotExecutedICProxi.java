...
public class AccountServiceNotExecutedICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountServiceNotExecuted{
    
    public AccountServiceNotExecutedICProxi(long objectId) {
        super(objectId);
    }
    public AccountServiceNotExecutedICProxi(PersistentObject object) {
        super(object);
    }
