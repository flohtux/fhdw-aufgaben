...
public class AccountServiceBankFeesICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountServiceBankFees{
    
    public AccountServiceBankFeesICProxi(long objectId) {
        super(objectId);
    }
    public AccountServiceBankFeesICProxi(PersistentObject object) {
        super(object);
    }
