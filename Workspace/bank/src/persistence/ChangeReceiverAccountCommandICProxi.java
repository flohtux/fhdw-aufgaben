...
public class ChangeReceiverAccountCommandICProxi extends PersistentInCacheProxi implements PersistentChangeReceiverAccountCommand{
    
    public ChangeReceiverAccountCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeReceiverAccountCommandICProxi(PersistentObject object) {
        super(object);
    }
