...
public abstract class DebitNoteTransactionProxi extends PersistentProxi implements PersistentDebitNoteTransaction{
    
    public DebitNoteTransactionProxi(long objectId) {
        super(objectId);
    }
    public DebitNoteTransactionProxi(PersistentInCacheProxi object) {
        super(object);
    }
