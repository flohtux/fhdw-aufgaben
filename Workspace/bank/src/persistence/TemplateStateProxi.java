...
public class TemplateStateProxi extends DebitTransferStateProxi implements PersistentTemplateState{
    ...
    public TemplateStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public PersistentDebitTransferState copy() 
				throws PersistenceException{
        return ((PersistentTemplateState)this.getTheObject()).copy();
    }
    ...
    public PersistentBooleanValue isCompensated() 
				throws PersistenceException{
        return ((PersistentTemplateState)this.getTheObject()).isCompensated();
    }
