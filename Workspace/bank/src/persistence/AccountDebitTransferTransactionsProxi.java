...
public class AccountDebitTransferTransactionsProxi extends PersistentProxi implements PersistentAccountDebitTransferTransactions{
    
    public AccountDebitTransferTransactionsProxi(long objectId) {
        super(objectId);
    }
    public AccountDebitTransferTransactionsProxi(PersistentInCacheProxi object) {
        super(object);
    }
