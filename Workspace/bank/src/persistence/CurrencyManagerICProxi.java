...
public class CurrencyManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentCurrencyManager{
    
    public CurrencyManagerICProxi(long objectId) {
        super(objectId);
    }
    public CurrencyManagerICProxi(PersistentObject object) {
        super(object);
    }
