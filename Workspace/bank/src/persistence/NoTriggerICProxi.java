...
public class NoTriggerICProxi extends TriggerValueICProxi implements PersistentNoTrigger{
    
    public NoTriggerICProxi(long objectId) {
        super(objectId);
    }
    public NoTriggerICProxi(PersistentObject object) {
        super(object);
    }
