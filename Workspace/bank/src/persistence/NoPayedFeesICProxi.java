...
public class NoPayedFeesICProxi extends DebitTransferPayedFeesICProxi implements PersistentNoPayedFees{
    
    public NoPayedFeesICProxi(long objectId) {
        super(objectId);
    }
    public NoPayedFeesICProxi(PersistentObject object) {
        super(object);
    }
