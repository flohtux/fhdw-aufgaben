...
public class ExchangeRateWrapperProxi extends PersistentProxi implements PersistentExchangeRateWrapper{
    
    public ExchangeRateWrapperProxi(long objectId) {
        super(objectId);
    }
    public ExchangeRateWrapperProxi(PersistentInCacheProxi object) {
        super(object);
    }
