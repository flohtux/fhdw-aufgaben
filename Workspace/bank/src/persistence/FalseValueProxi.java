...
public class FalseValueProxi extends BooleanValueProxi implements PersistentFalseValue{
    
    public FalseValueProxi(long objectId) {
        super(objectId);
    }
    public FalseValueProxi(PersistentInCacheProxi object) {
        super(object);
    }
