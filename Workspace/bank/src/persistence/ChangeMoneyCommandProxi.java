...
public class ChangeMoneyCommandProxi extends PersistentProxi implements PersistentChangeMoneyCommand{
    
    public ChangeMoneyCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeMoneyCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
