...
public class CompensationRequestListeICProxi extends PersistentInCacheProxiOptimistic implements PersistentCompensationRequestListe{
    
    public CompensationRequestListeICProxi(long objectId) {
        super(objectId);
    }
    public CompensationRequestListeICProxi(PersistentObject object) {
        super(object);
    }
