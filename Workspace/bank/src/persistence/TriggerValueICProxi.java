...
public abstract class TriggerValueICProxi extends PersistentInCacheProxiOptimistic implements PersistentTriggerValue{
    
    public TriggerValueICProxi(long objectId) {
        super(objectId);
    }
    public TriggerValueICProxi(PersistentObject object) {
        super(object);
    }
