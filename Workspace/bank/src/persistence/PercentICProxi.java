...
public class PercentICProxi extends PersistentInCacheProxiOptimistic implements PersistentPercent{
    
    public PercentICProxi(long objectId) {
        super(objectId);
    }
    public PercentICProxi(PersistentObject object) {
        super(object);
    }
