...
public class CompensationRequestedStateProxi extends DebitTransferStateProxi implements PersistentCompensationRequestedState{
    
    public CompensationRequestedStateProxi(long objectId) {
        super(objectId);
    }
    public CompensationRequestedStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
