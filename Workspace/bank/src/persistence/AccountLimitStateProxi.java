...
public abstract class AccountLimitStateProxi extends PersistentProxi implements PersistentAccountLimitState{
    
    public AccountLimitStateProxi(long objectId) {
        super(objectId);
    }
    public AccountLimitStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
