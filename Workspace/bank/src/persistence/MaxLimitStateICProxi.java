...
public class MaxLimitStateICProxi extends LimitStateICProxi implements PersistentMaxLimitState{
    
    public MaxLimitStateICProxi(long objectId) {
        super(objectId);
    }
    public MaxLimitStateICProxi(PersistentObject object) {
        super(object);
    }
