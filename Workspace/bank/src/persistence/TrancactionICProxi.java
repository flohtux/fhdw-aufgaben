...
public class TrancactionICProxi extends DebitNoteTransactionICProxi implements PersistentTrancaction{
    
    public TrancactionICProxi(long objectId) {
        super(objectId);
    }
    public TrancactionICProxi(PersistentObject object) {
        super(object);
    }
