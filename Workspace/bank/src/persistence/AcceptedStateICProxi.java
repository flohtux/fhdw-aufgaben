...
public class AcceptedStateICProxi extends CompensationRequestStateICProxi implements PersistentAcceptedState{
    
    public AcceptedStateICProxi(long objectId) {
        super(objectId);
    }
    public AcceptedStateICProxi(PersistentObject object) {
        super(object);
    }
