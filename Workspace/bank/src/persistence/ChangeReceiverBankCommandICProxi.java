...
public class ChangeReceiverBankCommandICProxi extends PersistentInCacheProxi implements PersistentChangeReceiverBankCommand{
    
    public ChangeReceiverBankCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeReceiverBankCommandICProxi(PersistentObject object) {
        super(object);
    }
