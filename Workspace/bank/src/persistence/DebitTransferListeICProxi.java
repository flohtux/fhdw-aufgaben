...
public class DebitTransferListeICProxi extends PersistentInCacheProxiOptimistic implements PersistentDebitTransferListe{
    
    public DebitTransferListeICProxi(long objectId) {
        super(objectId);
    }
    public DebitTransferListeICProxi(PersistentObject object) {
        super(object);
    }
