...
public class CompensationRequestICProxi extends PersistentInCacheProxiOptimistic implements PersistentCompensationRequest{
    
    public CompensationRequestICProxi(long objectId) {
        super(objectId);
    }
    public CompensationRequestICProxi(PersistentObject object) {
        super(object);
    }
