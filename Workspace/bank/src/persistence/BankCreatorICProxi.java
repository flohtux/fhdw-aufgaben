...
public class BankCreatorICProxi extends PersistentInCacheProxiOptimistic implements PersistentBankCreator{
    
    public BankCreatorICProxi(long objectId) {
        super(objectId);
    }
    public BankCreatorICProxi(PersistentObject object) {
        super(object);
    }
