...
public class SuccessfullStateICProxi extends DebitNoteTransferStateICProxi implements PersistentSuccessfullState{
    
    public SuccessfullStateICProxi(long objectId) {
        super(objectId);
    }
    public SuccessfullStateICProxi(PersistentObject object) {
        super(object);
    }
