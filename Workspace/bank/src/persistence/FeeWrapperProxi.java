...
public class FeeWrapperProxi extends PersistentProxi implements PersistentFeeWrapper{
    
    public FeeWrapperProxi(long objectId) {
        super(objectId);
    }
    public FeeWrapperProxi(PersistentInCacheProxi object) {
        super(object);
    }
