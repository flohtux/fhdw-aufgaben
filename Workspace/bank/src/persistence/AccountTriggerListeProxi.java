...
public class AccountTriggerListeProxi extends PersistentProxi implements PersistentAccountTriggerListe{
    
    public AccountTriggerListeProxi(long objectId) {
        super(objectId);
    }
    public AccountTriggerListeProxi(PersistentInCacheProxi object) {
        super(object);
    }
