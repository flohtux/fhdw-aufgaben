...
public class DebitTransferDoubleStateProxi extends PersistentProxi implements PersistentDebitTransferDoubleState{
    
    public DebitTransferDoubleStateProxi(long objectId) {
        super(objectId);
    }
    public DebitTransferDoubleStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
