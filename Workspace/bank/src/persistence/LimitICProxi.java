...
public class LimitICProxi extends LimitTypeICProxi implements PersistentLimit{
    
    public LimitICProxi(long objectId) {
        super(objectId);
    }
    public LimitICProxi(PersistentObject object) {
        super(object);
    }
