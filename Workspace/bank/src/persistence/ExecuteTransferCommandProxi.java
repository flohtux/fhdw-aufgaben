...
public class ExecuteTransferCommandProxi extends PersistentProxi implements PersistentExecuteTransferCommand{
    
    public ExecuteTransferCommandProxi(long objectId) {
        super(objectId);
    }
    public ExecuteTransferCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
