...
public class CreateDebitGrantCommandICProxi extends PersistentInCacheProxi implements PersistentCreateDebitGrantCommand{
    
    public CreateDebitGrantCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateDebitGrantCommandICProxi(PersistentObject object) {
        super(object);
    }
