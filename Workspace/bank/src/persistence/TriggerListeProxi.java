...
public class TriggerListeProxi extends PersistentProxi implements PersistentTriggerListe{
    
    public TriggerListeProxi(long objectId) {
        super(objectId);
    }
    public TriggerListeProxi(PersistentInCacheProxi object) {
        super(object);
    }
