...
public abstract class RuleICProxi extends PersistentInCacheProxiOptimistic implements PersistentRule{
    
    public RuleICProxi(long objectId) {
        super(objectId);
    }
    public RuleICProxi(PersistentObject object) {
        super(object);
    }
