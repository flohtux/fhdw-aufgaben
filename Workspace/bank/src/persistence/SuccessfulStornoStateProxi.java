...
public class SuccessfulStornoStateProxi extends StornoStateProxi implements PersistentSuccessfulStornoState{
    
    public SuccessfulStornoStateProxi(long objectId) {
        super(objectId);
    }
    public SuccessfulStornoStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
