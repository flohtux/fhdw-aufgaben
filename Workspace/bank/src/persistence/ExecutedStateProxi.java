...
public class ExecutedStateProxi extends DebitTransferStateProxi implements PersistentExecutedState{
    
    public ExecutedStateProxi(long objectId) {
        super(objectId);
    }
    public ExecutedStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public PersistentBooleanValue isCompensated() 
				throws PersistenceException{
        return ((PersistentExecutedState)this.getTheObject()).isCompensated();
    }
