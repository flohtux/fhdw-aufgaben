...
public class SuccessfulStateICProxi extends DebitTransferStateICProxi implements PersistentSuccessfulState{
    
    public SuccessfulStateICProxi(long objectId) {
        super(objectId);
    }
    public SuccessfulStateICProxi(PersistentObject object) {
        super(object);
    }
    ...
    public PersistentBooleanValue isCompensationRequest() 
				throws PersistenceException{
        return ((PersistentSuccessfulState)this.getTheObject()).isCompensationRequest();
    }
