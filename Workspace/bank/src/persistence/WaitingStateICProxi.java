...
public class WaitingStateICProxi extends CompensationRequestStateICProxi implements PersistentWaitingState{
    
    public WaitingStateICProxi(long objectId) {
        super(objectId);
    }
    public WaitingStateICProxi(PersistentObject object) {
        super(object);
    }
