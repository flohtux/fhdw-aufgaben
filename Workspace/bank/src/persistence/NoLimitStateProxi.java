...
public class NoLimitStateProxi extends AccountLimitStateProxi implements PersistentNoLimitState{
    
    public NoLimitStateProxi(long objectId) {
        super(objectId);
    }
    public NoLimitStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
