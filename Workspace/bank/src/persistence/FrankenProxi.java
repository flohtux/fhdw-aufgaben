...
public class FrankenProxi extends CurrencyProxi implements PersistentFranken{
    
    public FrankenProxi(long objectId) {
        super(objectId);
    }
    public FrankenProxi(PersistentInCacheProxi object) {
        super(object);
    }
