...
public class AccountServiceSuccessfullStatesICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountServiceSuccessfullStates{
    
    public AccountServiceSuccessfullStatesICProxi(long objectId) {
        super(objectId);
    }
    public AccountServiceSuccessfullStatesICProxi(PersistentObject object) {
        super(object);
    }
