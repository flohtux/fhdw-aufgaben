...
public class DebitGrantICProxi extends PersistentInCacheProxiOptimistic implements PersistentDebitGrant{
    
    public DebitGrantICProxi(long objectId) {
        super(objectId);
    }
    public DebitGrantICProxi(PersistentObject object) {
        super(object);
    }
