...
public class ExecuteCompensationCommandProxi extends PersistentProxi implements PersistentExecuteCompensationCommand{
    
    public ExecuteCompensationCommandProxi(long objectId) {
        super(objectId);
    }
    public ExecuteCompensationCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
