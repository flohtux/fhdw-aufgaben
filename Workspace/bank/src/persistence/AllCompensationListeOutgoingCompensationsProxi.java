...
public class AllCompensationListeOutgoingCompensationsProxi extends PersistentProxi implements PersistentAllCompensationListeOutgoingCompensations{
    
    public AllCompensationListeOutgoingCompensationsProxi(long objectId) {
        super(objectId);
    }
    public AllCompensationListeOutgoingCompensationsProxi(PersistentInCacheProxi object) {
        super(object);
    }
