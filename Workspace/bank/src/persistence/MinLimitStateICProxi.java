...
public class MinLimitStateICProxi extends LimitStateICProxi implements PersistentMinLimitState{
    
    public MinLimitStateICProxi(long objectId) {
        super(objectId);
    }
    public MinLimitStateICProxi(PersistentObject object) {
        super(object);
    }
