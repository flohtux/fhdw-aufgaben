...
public class DeclinedCompensationStateProxi extends CompensationStateProxi implements PersistentDeclinedCompensationState{
    
    public DeclinedCompensationStateProxi(long objectId) {
        super(objectId);
    }
    public DeclinedCompensationStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
