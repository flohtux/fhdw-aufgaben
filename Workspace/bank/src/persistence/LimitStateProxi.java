...
public abstract class LimitStateProxi extends AccountLimitStateProxi implements PersistentLimitState{
    
    public LimitStateProxi(long objectId) {
        super(objectId);
    }
    public LimitStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
