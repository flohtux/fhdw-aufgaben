...
public class InternalFeeProxi extends PersistentProxi implements PersistentInternalFee{
    
    public InternalFeeProxi(long objectId) {
        super(objectId);
    }
    public InternalFeeProxi(PersistentInCacheProxi object) {
        super(object);
    }
