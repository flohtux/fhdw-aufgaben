...
public class BankFeesProxi extends PersistentProxi implements PersistentBankFees{
    
    public BankFeesProxi(long objectId) {
        super(objectId);
    }
    public BankFeesProxi(PersistentInCacheProxi object) {
        super(object);
    }
