...
public abstract class CompensationStateICProxi extends PersistentInCacheProxiOptimistic implements PersistentCompensationState{
    
    public CompensationStateICProxi(long objectId) {
        super(objectId);
    }
    public CompensationStateICProxi(PersistentObject object) {
        super(object);
    }
