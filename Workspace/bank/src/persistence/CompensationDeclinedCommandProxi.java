...
public class CompensationDeclinedCommandProxi extends PersistentProxi implements PersistentCompensationDeclinedCommand{
    
    public CompensationDeclinedCommandProxi(long objectId) {
        super(objectId);
    }
    public CompensationDeclinedCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
