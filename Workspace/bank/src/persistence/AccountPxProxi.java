...
public class AccountPxProxi extends PersistentProxi implements PersistentAccountPx{
    
    public AccountPxProxi(long objectId) {
        super(objectId);
    }
    public AccountPxProxi(PersistentInCacheProxi object) {
        super(object);
    }
