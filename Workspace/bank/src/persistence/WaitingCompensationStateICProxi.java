...
public class WaitingCompensationStateICProxi extends CompensationStateICProxi implements PersistentWaitingCompensationState{
    
    public WaitingCompensationStateICProxi(long objectId) {
        super(objectId);
    }
    public WaitingCompensationStateICProxi(PersistentObject object) {
        super(object);
    }
