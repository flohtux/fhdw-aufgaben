...
public class NoRequestStateProxi extends StornoStateProxi implements PersistentNoRequestState{
    
    public NoRequestStateProxi(long objectId) {
        super(objectId);
    }
    public NoRequestStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
