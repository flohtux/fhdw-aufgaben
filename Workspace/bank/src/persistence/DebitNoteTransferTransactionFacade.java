...
public class DebitNoteTransferTransactionFacade{

	private String schemaName;
	private Connection con;

	public DebitNoteTransferTransactionFacade(String schemaName, Connection con) {
    ...
    public void ThisSet(long DebitNoteTransferTransactionId, PersistentDebitNoteTransferTransaction ThisVal) throws PersistenceException {
        try{
            CallableStatement callable;
