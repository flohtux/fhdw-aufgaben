...
public class ExecuteCommandProxi extends PersistentProxi implements PersistentExecuteCommand{
    
    public ExecuteCommandProxi(long objectId) {
        super(objectId);
    }
    public ExecuteCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
