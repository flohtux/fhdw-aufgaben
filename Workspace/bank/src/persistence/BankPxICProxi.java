...
public class BankPxICProxi extends PersistentInCacheProxiOptimistic implements PersistentBankPx{
    
    public BankPxICProxi(long objectId) {
        super(objectId);
    }
    public BankPxICProxi(PersistentObject object) {
        super(object);
    }
