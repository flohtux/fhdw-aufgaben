...
public class ProcentualFeeICProxi extends TransactionFeeICProxi implements PersistentProcentualFee{
    
    public ProcentualFeeICProxi(long objectId) {
        super(objectId);
    }
    public ProcentualFeeICProxi(PersistentObject object) {
        super(object);
    }
