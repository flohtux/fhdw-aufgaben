...
public class SuccessfulCompensationStateProxi extends CompensationStateProxi implements PersistentSuccessfulCompensationState{
    
    public SuccessfulCompensationStateProxi(long objectId) {
        super(objectId);
    }
    public SuccessfulCompensationStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
