...
public class AccountAllCompensationProxi extends PersistentProxi implements PersistentAccountAllCompensation{
    
    public AccountAllCompensationProxi(long objectId) {
        super(objectId);
    }
    public AccountAllCompensationProxi(PersistentInCacheProxi object) {
        super(object);
    }
