...
public class MixedFeeProxi extends TransactionFeeProxi implements PersistentMixedFee{
    
    public MixedFeeProxi(long objectId) {
        super(objectId);
    }
    public MixedFeeProxi(PersistentInCacheProxi object) {
        super(object);
    }
