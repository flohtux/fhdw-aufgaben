...
public class AccountReceivedDebitGrantProxi extends PersistentProxi implements PersistentAccountReceivedDebitGrant{
    
    public AccountReceivedDebitGrantProxi(long objectId) {
        super(objectId);
    }
    public AccountReceivedDebitGrantProxi(PersistentInCacheProxi object) {
        super(object);
    }
