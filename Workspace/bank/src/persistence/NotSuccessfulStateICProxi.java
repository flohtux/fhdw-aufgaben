...
public class NotSuccessfulStateICProxi extends DebitTransferStateICProxi implements PersistentNotSuccessfulState{
    
    public NotSuccessfulStateICProxi(long objectId) {
        super(objectId);
    }
    public NotSuccessfulStateICProxi(PersistentObject object) {
        super(object);
    }
    ...
    public PersistentBooleanValue isCompensationRequest() 
				throws PersistenceException{
        return ((PersistentNotSuccessfulState)this.getTheObject()).isCompensationRequest();
    }
    ...
    public PersistentBooleanValue isTransaction() 
				throws PersistenceException{
        return ((PersistentNotSuccessfulState)this.getTheObject()).isTransaction();
    }
