...
public class NoLimitICProxi extends LimitTypeICProxi implements PersistentNoLimit{
    
    public NoLimitICProxi(long objectId) {
        super(objectId);
    }
    public NoLimitICProxi(PersistentObject object) {
        super(object);
    }
    ...
    public void checkMaxLimit(final PersistentMoney money) 
        ...
        ((PersistentNoLimit)this.getTheObject()).checkMaxLimit(money);
    }
