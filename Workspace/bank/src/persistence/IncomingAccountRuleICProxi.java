...
public class IncomingAccountRuleICProxi extends RuleICProxi implements PersistentIncomingAccountRule{
    
    public IncomingAccountRuleICProxi(long objectId) {
        super(objectId);
    }
    public IncomingAccountRuleICProxi(PersistentObject object) {
        super(object);
    }
