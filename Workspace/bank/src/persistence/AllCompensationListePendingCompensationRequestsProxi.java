...
public class AllCompensationListePendingCompensationRequestsProxi extends PersistentProxi implements PersistentAllCompensationListePendingCompensationRequests{
    
    public AllCompensationListePendingCompensationRequestsProxi(long objectId) {
        super(objectId);
    }
    public AllCompensationListePendingCompensationRequestsProxi(PersistentInCacheProxi object) {
        super(object);
    }
