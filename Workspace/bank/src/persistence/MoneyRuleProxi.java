...
public class MoneyRuleProxi extends RuleProxi implements PersistentMoneyRule{
    
    public MoneyRuleProxi(long objectId) {
        super(objectId);
    }
    public MoneyRuleProxi(PersistentInCacheProxi object) {
        super(object);
    }
