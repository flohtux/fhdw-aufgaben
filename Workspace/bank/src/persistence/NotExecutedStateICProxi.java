...
public class NotExecutedStateICProxi extends DebitTransferStateICProxi implements PersistentNotExecutedState{
    
    public NotExecutedStateICProxi(long objectId) {
        super(objectId);
    }
    public NotExecutedStateICProxi(PersistentObject object) {
        super(object);
    }
    ...
    public PersistentBooleanValue isCompensationRequest() 
				throws PersistenceException{
        return ((PersistentNotExecutedState)this.getTheObject()).isCompensationRequest();
    }
