...
public abstract class DebitNoteTransferProxi extends DebitNoteTransferTransactionProxi implements PersistentDebitNoteTransfer{
    ...
    public String getSubject() throws PersistenceException {
        return ((PersistentDebitNoteTransfer)this.getTheObject()).getSubject();
    }
    public void setSubject(String newValue) throws PersistenceException {
        ((PersistentDebitNoteTransfer)this.getTheObject()).setSubject(newValue);
    }
    ...
    public void executeImplementation() 
				throws model.InvalidBankNumberException, model.LimitViolatedException, model.InvalidAccountNumberException, model.NoPermissionToExecuteDebitNoteTransferException, PersistenceException{
        ((PersistentDebitNoteTransfer)this.getTheObject()).executeImplementation();
    }
