...
public class DebitTransferPayedFeesICProxi extends PersistentInCacheProxiOptimistic implements PersistentDebitTransferPayedFees{
    
    public DebitTransferPayedFeesICProxi(long objectId) {
        super(objectId);
    }
    public DebitTransferPayedFeesICProxi(PersistentObject object) {
        super(object);
    }
