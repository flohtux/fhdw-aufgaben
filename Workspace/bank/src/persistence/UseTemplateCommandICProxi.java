...
public class UseTemplateCommandICProxi extends PersistentInCacheProxi implements PersistentUseTemplateCommand{
    
    public UseTemplateCommandICProxi(long objectId) {
        super(objectId);
    }
    public UseTemplateCommandICProxi(PersistentObject object) {
        super(object);
    }
