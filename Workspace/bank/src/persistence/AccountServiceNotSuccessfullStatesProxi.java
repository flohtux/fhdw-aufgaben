...
public class AccountServiceNotSuccessfullStatesProxi extends PersistentProxi implements PersistentAccountServiceNotSuccessfullStates{
    
    public AccountServiceNotSuccessfullStatesProxi(long objectId) {
        super(objectId);
    }
    public AccountServiceNotSuccessfullStatesProxi(PersistentInCacheProxi object) {
        super(object);
    }
