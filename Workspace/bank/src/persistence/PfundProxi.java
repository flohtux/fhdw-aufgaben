...
public class PfundProxi extends CurrencyProxi implements PersistentPfund{
    
    public PfundProxi(long objectId) {
        super(objectId);
    }
    public PfundProxi(PersistentInCacheProxi object) {
        super(object);
    }
