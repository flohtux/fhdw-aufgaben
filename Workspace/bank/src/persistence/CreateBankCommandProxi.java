...
public class CreateBankCommandProxi extends PersistentProxi implements PersistentCreateBankCommand{
    
    public CreateBankCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateBankCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
