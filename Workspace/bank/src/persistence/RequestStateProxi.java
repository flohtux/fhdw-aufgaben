...
public class RequestStateProxi extends StornoStateProxi implements PersistentRequestState{
    
    public RequestStateProxi(long objectId) {
        super(objectId);
    }
    public RequestStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
