...
public class NotExecutableStateICProxi extends DebitTransferStateICProxi implements PersistentNotExecutableState{
    ...
    public PersistentDebitTransferState copy() 
				throws PersistenceException{
        return ((PersistentNotExecutableState)this.getTheObject()).copy();
    }
    ...
    public PersistentBooleanValue isCompensated() 
				throws PersistenceException{
        return ((PersistentNotExecutableState)this.getTheObject()).isCompensated();
    }
    ...
    public PersistentBooleanValue isTransaction() 
				throws PersistenceException{
        return ((PersistentNotExecutableState)this.getTheObject()).isTransaction();
    }
