...
public class AccountServiceTemplateICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountServiceTemplate{
    
    public AccountServiceTemplateICProxi(long objectId) {
        super(objectId);
    }
    public AccountServiceTemplateICProxi(PersistentObject object) {
        super(object);
    }
