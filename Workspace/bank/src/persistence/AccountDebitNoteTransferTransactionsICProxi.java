...
public class AccountDebitNoteTransferTransactionsICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountDebitNoteTransferTransactions{
    
    public AccountDebitNoteTransferTransactionsICProxi(long objectId) {
        super(objectId);
    }
    public AccountDebitNoteTransferTransactionsICProxi(PersistentObject object) {
        super(object);
    }
