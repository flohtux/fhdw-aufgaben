...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(114, "Account");
		this.number2NameMap.put(-126, "AccountService");
		this.number2NameMap.put(-112, "Administrator");
		this.number2NameMap.put(131, "AdministratorBanks");
		this.number2NameMap.put(146, "Amount");
		this.number2NameMap.put(-113, "Bank");
		this.number2NameMap.put(123, "BankCreator");
		this.number2NameMap.put(-127, "BankService");
		this.number2NameMap.put(130, "ChangeNameCommand");
		this.number2NameMap.put(-117, "CommandCoordinator");
		this.number2NameMap.put(-116, "CommandExecuter");
		this.number2NameMap.put(119, "CommonDate");
		this.number2NameMap.put(135, "CreateAccountCommand");
		this.number2NameMap.put(125, "CreateBankCommand");
		this.number2NameMap.put(151, "DebitNote");
		this.number2NameMap.put(137, "Dollar");
		this.number2NameMap.put(-101, "ErrorDisplay");
		this.number2NameMap.put(136, "Euro");
		this.number2NameMap.put(142, "FixTransactionFee");
		this.number2NameMap.put(145, "MaxLimitState");
		this.number2NameMap.put(143, "MinLimitState");
		this.number2NameMap.put(139, "MixedFee");
		this.number2NameMap.put(147, "Money");
		this.number2NameMap.put(140, "NoLimitState");
		this.number2NameMap.put(148, "ProcentualFee");
		this.number2NameMap.put(-102, "Server");
		this.number2NameMap.put(129, "Subj");
		this.number2NameMap.put(152, "Trancaction");	
	}
