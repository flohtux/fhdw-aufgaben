        ...
        try{
            ...
            while(links.next()){
                ...
                switch ((int)associationId) {
                    ...
                    case 10316: {
                        triggerListe = (PersistentAccountTriggerListe)PersistentProxi.createProxi(links.getLong(3), links.getLong(4));
                        break;
                    }
                    case 10384: {
                        allCompensation = (PersistentAccountAllCompensation)PersistentProxi.createProxi(links.getLong(3), links.getLong(4));
                        break;
                    }
                    case 10064: {
