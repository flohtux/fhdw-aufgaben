...
public class ChangeSubjectCommandICProxi extends PersistentInCacheProxi implements PersistentChangeSubjectCommand{
    
    public ChangeSubjectCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeSubjectCommandICProxi(PersistentObject object) {
        super(object);
    }
