...
public interface UserExceptionReturnExceptionVisitor<R, E extends UserException> extends ExecuteExceptionReturnExceptionVisitor<R, E> {
    ...
    public R handleCompensationAbortedException(CompensationAbortedException compensationAbortedException) throws ModelException, E;
    ...
    public R handleNoPermissionToRemoveDebitGrantException(NoPermissionToRemoveDebitGrantException noPermissionToRemoveDebitGrantException) throws ModelException, E;
