...
public interface UserExceptionReturnExceptionVisitor<R, E extends UserException> {
    ...
    public R handleNoPermissionToExecuteDebitNoteTransferException(NoPermissionToExecuteDebitNoteTransferException noPermissionToExecuteDebitNoteTransferException) throws ModelException, E;
