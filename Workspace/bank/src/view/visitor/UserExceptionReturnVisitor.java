...
public interface UserExceptionReturnVisitor<R> extends ExecuteExceptionReturnVisitor<R> {
    ...
    public R handleMaximumIsLowerThenMinimumException(MaximumIsLowerThenMinimumException maximumIsLowerThenMinimumException) throws ModelException;
    ...
    public R handleMinimumIsHigherThenMaximumException(MinimumIsHigherThenMaximumException minimumIsHigherThenMaximumException) throws ModelException;
