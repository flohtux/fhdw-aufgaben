...
public class NotSuccessfullStorneStateProxi extends StornoStateProxi implements NotSuccessfullStorneStateView{
    
    public NotSuccessfullStorneStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NotSuccessfullStorneStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        NotSuccessfullStorneStateView result$$ = new NotSuccessfullStorneState((DebitNoteTransferStateView)debitNoteTransfer, this.getId(), this.getClassId());
