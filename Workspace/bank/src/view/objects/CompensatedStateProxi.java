...
public class CompensatedStateProxi extends DebitTransferStateProxi implements CompensatedStateView{
    
    public CompensatedStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public CompensatedStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        CompensatedStateView result$$ = new CompensatedState((DebitTransferTransactionView)debitTransfer, this.getId(), this.getClassId());
