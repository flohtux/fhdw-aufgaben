...
public class NotSuccessfulStornoStateProxi extends StornoStateProxi implements NotSuccessfulStornoStateView{
    ...
    public NotSuccessfulStornoStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NotSuccessfulStornoStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
