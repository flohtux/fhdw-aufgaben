...
public class NotExecutetState extends view.objects.DebitNoteTransferState implements NotExecutetStateView{
    
    
    public NotExecutetState(DebitNoteTransferStateView state,StornoStateView stornoState,DebitNoteTransferStateView debitNoteTransfer,long id, long classId) {
