...
public class MaxLimitStateProxi extends LimitStateProxi implements MaxLimitStateView{
    
    public MaxLimitStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public MaxLimitStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        MaxLimitStateView result$$ = new MaxLimitState((AmountView)balance, this.getId(), this.getClassId());
