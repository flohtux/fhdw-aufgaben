  ...
  private static ProxiFactory [] getTheProxiFactories(){
	if (proxiFactories == null){
        ...
        proxiFactories[172] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new ExchangeRateWrapperProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[161] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new BankOwnAccountPxProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[162] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new WaitingStateProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[182] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new CompensationRequestedStateProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[177] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new WaitingCompensationStateProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[181] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new CompensatedStateProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[178] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new SuccessfulCompensationStateProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[164] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new AcceptedStateProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[186] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new NoPayedFeesProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[187] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new DebitTransferPayedFeesProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[180] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new DeclinedCompensationStateProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[165] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new DeclinedStateProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[185] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new DebitGrantListePxProxi(objectId, classId, connectionKey);
            }
        };
