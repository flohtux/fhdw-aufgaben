...
public class SuccessfullStornoStateProxi extends StornoStateProxi implements SuccessfullStornoStateView{
    
    public SuccessfullStornoStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public SuccessfullStornoStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        SuccessfullStornoStateView result$$ = new SuccessfullStornoState((DebitNoteTransferStateView)debitNoteTransfer, this.getId(), this.getClassId());
