...
public class SuccessfullState extends view.objects.DebitNoteTransferState implements SuccessfullStateView{
    
    
    public SuccessfullState(DebitNoteTransferStateView state,StornoStateView stornoState,DebitNoteTransferStateView debitNoteTransfer,long id, long classId) {
