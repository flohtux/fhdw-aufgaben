...
public class NotExecutableState extends view.objects.DebitTransferState implements NotExecutableStateView{
    
    
    public NotExecutableState(DebitTransferTransactionView debitTransfer,long id, long classId) {
