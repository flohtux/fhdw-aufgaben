...
public class NotExecutableState extends view.objects.DebitNoteTransferState implements NotExecutableStateView{
    
    
    public NotExecutableState(DebitNoteTransferStateView state,StornoStateView stornoState,DebitNoteTransferStateView debitNoteTransfer,long id, long classId) {
