...
public class CompensationRequestedState extends view.objects.DebitTransferState implements CompensationRequestedStateView{
    
    
    public CompensationRequestedState(DebitTransferTransactionView debitTransfer,long id, long classId) {
