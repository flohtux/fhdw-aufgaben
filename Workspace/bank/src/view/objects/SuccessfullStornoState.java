...
public class SuccessfullStornoState extends view.objects.StornoState implements SuccessfullStornoStateView{
    
    
    public SuccessfullStornoState(DebitNoteTransferStateView debitNoteTransfer,long id, long classId) {
