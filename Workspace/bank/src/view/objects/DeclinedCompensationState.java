...
import view.DeclinedCompensationStateView;
...
public class DeclinedCompensationState extends view.objects.CompensationState implements DeclinedCompensationStateView{
    
    
    public DeclinedCompensationState(CompensationView compensation,long id, long classId) {
