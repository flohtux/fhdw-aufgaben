...
public class TemplateState extends view.objects.DebitNoteTransferState implements TemplateStateView{
    
    
    public TemplateState(DebitNoteTransferStateView state,StornoStateView stornoState,DebitNoteTransferStateView debitNoteTransfer,long id, long classId) {
