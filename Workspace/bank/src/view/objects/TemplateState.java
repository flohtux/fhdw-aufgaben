...
public class TemplateState extends view.objects.DebitTransferState implements TemplateStateView{
    
    
    public TemplateState(DebitTransferTransactionView debitTransfer,long id, long classId) {
