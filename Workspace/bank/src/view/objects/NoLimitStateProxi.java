...
public class NoLimitStateProxi extends AccountLimitStateProxi implements NoLimitStateView{
    
    public NoLimitStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NoLimitStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        NoLimitStateView result$$ = new NoLimitState( this.getId(), this.getClassId());
