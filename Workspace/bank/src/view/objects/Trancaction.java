...
public class Trancaction extends view.objects.DebitNoteTransaction implements TrancactionView{
    
    
    public Trancaction(long bankNumber,long accountNumber,MoneyView money,long id, long classId) {
