...
import view.NoRequestStateView;
...
public class NoRequestStateProxi extends StornoStateProxi implements NoRequestStateView{
    
    public NoRequestStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NoRequestStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
