...
public class DebitNoteProxi extends DebitNoteTransferProxi implements DebitNoteView{
    ...
    public DebitNoteView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        DebitNoteView result$$ = new DebitNote((java.util.Date)timestamp,(long)receiverAccountNumber,(long)receiverBankNumber,(AccountView)sender,(MoneyView)money,(String)subject,(DebitNoteTransferStateView)state,(StornoStateView)stornoState, this.getId(), this.getClassId());
