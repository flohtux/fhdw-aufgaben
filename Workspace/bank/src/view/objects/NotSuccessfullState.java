...
public class NotSuccessfullState extends view.objects.DebitNoteTransferState implements NotSuccessfullStateView{
    ...
    public NotSuccessfullState(DebitNoteTransferStateView state,StornoStateView stornoState,DebitNoteTransferStateView debitNoteTransfer,long id, long classId) {
