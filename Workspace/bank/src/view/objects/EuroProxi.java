...
public class EuroProxi extends CurrencyProxi implements EuroView{
    
    public EuroProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public EuroView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        EuroView result$$ = new Euro( this.getId(), this.getClassId());
