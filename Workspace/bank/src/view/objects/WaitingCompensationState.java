...
import view.WaitingCompensationStateView;
...
public class WaitingCompensationState extends view.objects.CompensationState implements WaitingCompensationStateView{
    
    
    public WaitingCompensationState(CompensationView compensation,long id, long classId) {
