...
public class DebitNote extends view.objects.DebitNoteTransfer implements DebitNoteView{
    ...
    public DebitNote(java.util.Date timestamp,long receiverAccountNumber,long receiverBankNumber,AccountView sender,MoneyView money,String subject,DebitNoteTransferStateView state,StornoStateView stornoState,long id, long classId) {
