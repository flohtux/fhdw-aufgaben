...
public class NotSuccessfulStateProxi extends DebitTransferStateProxi implements NotSuccessfulStateView{
    
    public NotSuccessfulStateProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NotSuccessfulStateView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
