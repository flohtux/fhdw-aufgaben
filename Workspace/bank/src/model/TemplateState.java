...
public class TemplateState extends model.DebitNoteTransferState implements PersistentTemplateState{
    ...
    public TemplateState provideCopy() throws PersistenceException{
        ...
        result = new TemplateState(this.state, 
                                   this.stornoState, 
                                   this.subService, 
                                   this.This, 
                                   this.getId());
    ...
    public TemplateState(PersistentDebitNoteTransferState state,PersistentStornoState stornoState,SubjInterface subService,PersistentDebitNoteTransferState This,long id) throws persistence.PersistenceException {
