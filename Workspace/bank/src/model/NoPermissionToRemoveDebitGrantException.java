...
public class NoPermissionToRemoveDebitGrantException extends model.UserException{
    ...
    public NoPermissionToRemoveDebitGrantException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public NoPermissionToRemoveDebitGrantException() throws PersistenceException {
		this (serverConstants.ExceptionMessages.NoPermissionToRemoveDebitGrantMessage);
	}
