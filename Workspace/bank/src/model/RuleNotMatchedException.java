...
public class RuleNotMatchedException extends model.UserException{
    ...
    public RuleNotMatchedException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public RuleNotMatchedException() throws PersistenceException {
		this(serverConstants.ExceptionMessages.RuleNotMatchedMessage);
	}
