...
import persistence.YenProxi;


/* Additional import section end */

public class Yen extends model.Currency implements PersistentYen{
    
    private static PersistentYen theYen = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static PersistentYen getTheYen() throws PersistenceException{
        if (theYen == null || reset$For$Test){
            class Initializer implements Runnable {
                ...
                public void run(){
                    try {
                        YenProxi proxi = null;
                        synchronized ($$lock){
                            proxi = ConnectionHandler.getTheConnectionHandler().theYenFacade.getTheYen();
                            theYen = proxi;
                        }
                        if(proxi.getId() < 0) {
                ...
                PersistentYen getResult() throws PersistenceException{
    ...
    public Yen provideCopy() throws PersistenceException{
        Yen result = this;
        result = new Yen(this.subService, 
                         this.This, 
                         this.getId());
    ...
    public Yen(SubjInterface subService,PersistentCurrency This,long id) throws persistence.PersistenceException {
    ...
    public PersistentYen getThis() throws PersistenceException {
        if(this.This == null){
            PersistentYen result = new YenProxi(this.getId());
            result.getTheObject();
            return result;
        }return (PersistentYen)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentYen)This);
		if(this.equals(This)){
		}
    }
