...
public class CloseAccountNoPossibleException extends model.UserException{
    ...
    public CloseAccountNoPossibleException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public CloseAccountNoPossibleException() throws persistence.PersistenceException {
        super(viewConstants.ExceptionConstants.CloseAccountNotPossible);        
    }
