...
public class NoRuleDefinitionException extends model.UserException{
    ...
    public NoRuleDefinitionException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public NoRuleDefinitionException() throws PersistenceException {
		this(serverConstants.ExceptionMessages.NoRouleDefinitionMessage);
	}
