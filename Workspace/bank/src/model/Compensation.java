...
public class Compensation extends PersistentObject implements PersistentCompensation {
	...
	public static PersistentCompensation createCompensation(PersistentAccount requestingAccount, boolean delayed$Persistence) throws PersistenceException {
		...
		if (delayed$Persistence) {
			result = ConnectionHandler.getTheConnectionHandler().theCompensationFacade.newDelayedCompensation();
			result.setDelayed$Persistence(true);
		} else {
			result = ConnectionHandler.getTheConnectionHandler().theCompensationFacade.newCompensation(-1);
		}
	...
	public static PersistentCompensation createCompensation(PersistentAccount requestingAccount, boolean delayed$Persistence, PersistentCompensation This)
	...
	public java.util.HashMap<String, Object> toHashtable(java.util.HashMap<String, Object> allResults, int depth, int essentialLevel, boolean forGUI,
			boolean leaf, TDObserver tdObserver) throws PersistenceException {
		...
		if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth) {
			...
			if (requestingAccount != null) {
				...
				if (depth > 1) {
					...
					if (forGUI && requestingAccount.hasEssentialFields())
						requestingAccount.toHashtable(allResults, depth, essentialLevel + 1, false, true, tdObserver);
				}
			}
			result.put("pendingRequests",
					this.getPendingRequests().getObservee().getVector(allResults, depth, essentialLevel, forGUI, tdObserver, false, essentialLevel == 0));
			...
			if (stornoState != null) {
				...
				if (depth > 1) {
					...
					if (forGUI && stornoState.hasEssentialFields())
						stornoState.toHashtable(allResults, depth, essentialLevel + 1, false, true, tdObserver);
				}
			}
	...
	public Compensation provideCopy() throws PersistenceException {
		...
		result = new Compensation(this.requestingAccount, this.pendingRequests, this.stornoState, this.subService, this.This, this.getId());
	...
	public Compensation(PersistentAccount requestingAccount, PersistentCompensationPendingRequests pendingRequests, PersistentStornoState stornoState,
			SubjInterface subService, PersistentCompensation This, long id) throws persistence.PersistenceException {
		/*
	...
	public void store() throws PersistenceException {
		if (!this.isDelayed$Persistence())
			return;
		if (this.getClassId() == 254)
			ConnectionHandler.getTheConnectionHandler().theCompensationFacade.newCompensation(this.getId());
		super.store();
	...
	public void setRequestingAccount(PersistentAccount newValue) throws PersistenceException {
		...
		if (newValue.equals(this.requestingAccount))
			return;
	...
	protected void setPendingRequests(PersistentCompensationPendingRequests newValue) throws PersistenceException {
		if (newValue == null)
			throw new PersistenceException("Null values not allowed!", 0);
		if (newValue.equals(this.pendingRequests))
			return;
		long objectId = newValue.getId();
		long classId = newValue.getClassId();
	...
	public void setStornoState(PersistentStornoState newValue) throws PersistenceException {
		if (newValue == null)
			throw new PersistenceException("Null values not allowed!", 0);
		if (newValue.equals(this.stornoState))
			return;
		long objectId = newValue.getId();
		long classId = newValue.getClassId();
	...
	public void setSubService(SubjInterface newValue) throws PersistenceException {
		if (newValue == null)
			throw new PersistenceException("Null values not allowed!", 0);
		if (newValue.equals(this.subService))
			return;
		long objectId = newValue.getId();
		long classId = newValue.getClassId();
	...
	public int getLeafInfo() throws PersistenceException {
		if (this.getRequestingAccount() != null)
			return 1;
		if (this.getPendingRequests().getObservee().getLength() > 0)
			return 1;
		if (this.getStornoState() != null)
			return 1;
		return 0;
	...
	public void executeCompensation(final Invoker invoker) throws PersistenceException {
	...
	public PersistentCompensationPendingRequests getPendingRequests() throws PersistenceException {
		if (this.pendingRequests == null) {
	...
	public PersistentBooleanValue allAnswered() throws model.CompensationAbortedException, PersistenceException {
	...
	public void executeCompensation() throws PersistenceException {
	...
	public void initializeDebitTransferTransaction(final PersistentDebitTransferTransaction dtt) throws PersistenceException {
	...
	public void pendingRequests_update(final model.meta.CompensationRequestMssgs event) throws PersistenceException {
	...
	public void requestCompensationForDebitTransfers(final DebitTransferSearchList debitTransfers) throws PersistenceException {
	...
	public void requestCompensationForDebitTransfer(final PersistentDebitTransfer debitTransfer) throws PersistenceException {
