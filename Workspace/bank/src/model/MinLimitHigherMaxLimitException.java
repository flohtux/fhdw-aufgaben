...
public class MinLimitHigherMaxLimitException extends model.UserException{
    ...
    public MinLimitHigherMaxLimitException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public MinLimitHigherMaxLimitException() throws PersistenceException {
