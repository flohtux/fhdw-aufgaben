...
public class GrantAlreadyGivenException extends model.UserException{
    ...
    public GrantAlreadyGivenException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public GrantAlreadyGivenException() throws PersistenceException {
		this(serverConstants.ExceptionMessages.GrantAlreadyGivenMessage);
	}
