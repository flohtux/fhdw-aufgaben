...
public class MaximumIsLowerThenMinimumException extends model.UserException{
    ...
    public MaximumIsLowerThenMinimumException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public MaximumIsLowerThenMinimumException() throws PersistenceException {
