...
public class DoubleRuleDefinitionException extends model.UserException{
    ...
    public DoubleRuleDefinitionException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public DoubleRuleDefinitionException() throws PersistenceException {
		this(serverConstants.ExceptionMessages.DoubleRuleDefinitionMessage);
	}
