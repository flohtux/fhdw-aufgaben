...
public class NotExecutetState extends model.DebitNoteTransferState implements PersistentNotExecutetState{
    ...
    public NotExecutetState provideCopy() throws PersistenceException{
        ...
        result = new NotExecutetState(this.state, 
                                      this.stornoState, 
                                      this.subService, 
                                      this.This, 
                                      this.getId());
    ...
    public NotExecutetState(PersistentDebitNoteTransferState state,PersistentStornoState stornoState,SubjInterface subService,PersistentDebitNoteTransferState This,long id) throws persistence.PersistenceException {
