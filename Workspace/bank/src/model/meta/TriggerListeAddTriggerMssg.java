...
public class TriggerListeAddTriggerMssg implements TriggerListeDOWNMssgs,TriggerListeUPMssgs{
    ...
    public TriggerListeAddTriggerMssg(persistence.PersistentTrigger t,
    ...
    public void accept(TriggerListeMssgsVisitor visitor) throws persistence.PersistenceException{
        visitor.handleTriggerListeAddTriggerMssg(this);
    }
