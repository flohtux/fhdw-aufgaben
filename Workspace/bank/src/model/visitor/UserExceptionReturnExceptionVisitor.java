...
public interface UserExceptionReturnExceptionVisitor<R, E extends UserException> extends ExecuteExceptionReturnExceptionVisitor<R, E> {
    ...
    public R handleMaximumIsLowerThenMinimumException(model.MaximumIsLowerThenMinimumException maximumIsLowerThenMinimumException) throws PersistenceException, E;
    ...
    public R handleMinimumIsHigherThenMaximumException(model.MinimumIsHigherThenMaximumException minimumIsHigherThenMaximumException) throws PersistenceException, E;
