...
public interface UserExceptionReturnExceptionVisitor<R, E extends UserException> {
    ...
    public R handleNoPermissionToExecuteDebitNoteTransferException(model.NoPermissionToExecuteDebitNoteTransferException noPermissionToExecuteDebitNoteTransferException) throws PersistenceException, E;
