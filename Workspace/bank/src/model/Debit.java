...
public class Debit extends model.DebitTransfer implements PersistentDebit{
    ...
    private static PersistentDebit theDebit = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static PersistentDebit getTheDebit() throws PersistenceException{
        if (theDebit == null || reset$For$Test){
            class Initializer implements Runnable {
                PersistenceException exception = null;
                public void run(){
                    try {
                        DebitProxi proxi = null;
                        synchronized ($$lock){
                            proxi = ConnectionHandler.getTheConnectionHandler().theDebitFacade.getTheDebit();
                            theDebit = proxi;
                        }
                        if(proxi.getId() < 0) {
                ...
                PersistentDebit getResult() throws PersistenceException{
