...
drop sequence SAccntSrvcSucstates;
drop table AccntSrvcSucstates cascade constraints;
drop sequence SSrvc;
...
drop sequence SAccntSrvcNtsucstates;
drop table AccntSrvcNtsucstates cascade constraints;
...
drop sequence SAccntSrvcSucstatesObs;
drop table AccntSrvcSucstatesObs cascade constraints;
...
drop sequence SAccntSrvcNtsucstatesObs;
drop table AccntSrvcNtsucstatesObs cascade constraints;
drop sequence SAdmnstrtrBnksObs;
drop table AdmnstrtrBnksObs cascade constraints;
drop sequence SAccntGrntdGrnts;
drop table AccntGrntdGrnts cascade constraints;
drop sequence SAccntRcvdGrnts;
drop table AccntRcvdGrnts cascade constraints;
